...
# usage: bash largeOligoRMA_driver.sh geoDir
# usage ex: bash largeOligoRMA_driver.sh GSE8888n_4_5_6
# usage ex: bash largeOligoRMA_driver.sh GSE88884
# usage ex: bash largeOligoRMA_driver.sh GSE88885
# usage ex: bash largeOligoRMA_driver.sh GSE88886
