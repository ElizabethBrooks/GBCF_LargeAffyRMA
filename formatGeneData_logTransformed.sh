...
# usage: bash formatGeneData_logTransformed.sh workingDir celSet mapFile
# usage ex: bash formatGeneData_logTransformed.sh /Users/bamflappy/GBCF/DxTerity/Data/Normalized/NormalizedMerged GSE8888n_4_5_6 /Users/bamflappy/GBCF/DxTerity/Data/Annotations/HTA_2_0_HGNC_map_cleaned.csv
# usage ex: bash formatGeneData_logTransformed.sh /afs/crc.nd.edu/group/genomics/Mando/GBCF_bioinformatics_DxTerity_combined/rma_aromaAffy/results GSE8888n_4_5_6 /afs/crc.nd.edu/group/genomics/Mando/GBCF_bioinformatics_DxTerity_combined/rma_aromaAffy/results/HTA_2_0_HGNC_map_cleaned.csv
# usage ex: bash formatGeneData_logTransformed.sh /afs/crc.nd.edu/group/genomics/Mando/GBCF_bioinformatics_DxTerity_combined/Data/Normalized/NormalizedMerged/ GSE8888n_4_5_6 /afs/crc.nd.edu/group/genomics/Mando/GBCF_bioinformatics_DxTerity_combined/Data/Annotations/HTA_2_0_HGNC_map_cleaned.csv
